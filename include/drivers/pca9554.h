...
maus_bus_err_t
pca9554_set_gpio_level(uint8_t address, uint8_t gpio_num, pca9554_gpio_level_t level);
...
maus_bus_err_t
pca9554_get_gpio_level(uint8_t address, uint8_t gpio_num, pca9554_gpio_level_t* level);
